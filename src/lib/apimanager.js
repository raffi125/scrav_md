...
class TegarxApiProvider extends ScravBotApiProvider {
  ytmp3(input, opt = {}) { return this.get("/api/download/ytmp3", this.asParams(input, "url"), opt); }
  ytmp3v2(input, opt = {}) { return this.get("/api/download/ytmp3-2", this.asParams(input, "url"), opt); }
  ytmp4v2(input, opt = {}) { return this.get("/api/download/ytmp4-2", this.asParams(input, "url"), opt); }
  tiktok(input, opt = {}) { return this.get("/api/download/tiktok", this.asParams(input, "url"), opt); }
  instagram(input, opt = {}) { return this.get("/api/download/instagram", this.asParams(input, "url"), opt); }
  igReels(input, opt = {}) { return this.get("/api/download/instagram-reels", this.asParams(input, "url"), opt); }
  igStory(input, opt = {}) { return this.get("/api/download/instagram-story", this.asParams(input, "url"), opt); }
}

class HarzApiProvider extends ScravBotApiProvider {
  igV4(input, opt = {}) { return this.get("/api/v2/ig-v4", this.asParams(input, "q"), opt); }
  igV3(input, opt = {}) { return this.get("/api/v2/ig-v3", this.asParams(input, "q"), opt); }
  igV2(input, opt = {}) { return this.get("/api/v2/ig-v2", this.asParams(input, "q"), opt); }
  onlymp3(input, opt = {}) { return this.get("/api/v2/onlymp3", this.asParams(input, "q"), opt); }
  spotify(input, opt = {}) { return this.get("/api/v2/spotify", this.asParams(input, "q"), opt); }
  spotifyV5(input, opt = {}) { return this.get("/api/v2/spotify-v5", this.asParams(input, "q"), opt); }
  spotifyV4(input, opt = {}) { return this.get("/api/v2/spotify-v4", this.asParams(input, "q"), opt); }
  spotifyV3(input, opt = {}) { return this.get("/api/v2/spotify-v3", this.asParams(input, "q"), opt); }
  tiktok(input, opt = {}) { return this.get("/api/v2/tiktok", this.asParams(input, "q"), opt); }
  tiktokV4(input, opt = {}) { return this.get("/api/v2/tiktok-v4", this.asParams(input, "q"), opt); }
  tiktokV3(input, opt = {}) { return this.get("/api/v2/tiktok-v3", this.asParams(input, "q"), opt); }
  tiktokV2(input, opt = {}) { return this.get("/api/v2/tiktok-v2", this.asParams(input, "q"), opt); }
  ytdlV2(input, opt = {}) { return this.get("/api/v2/ytdl-v2", this.asParams(input, "q"), opt); }
  ytdlV3(input, opt = {}) { return this.get("/api/v2/ytdl-v3", this.asParams(input, "q"), opt); }
  ytdlV4(input, opt = {}) { return this.get("/api/v2/ytdl-v4", this.asParams(input, "q"), opt); }
  ytdl(input, opt = {}) { return this.get("/api/v2/ytdl", this.asParams(input, "q"), opt); }
  ytmp3(input, opt = {}) { return this.get("/api/v2/ytmp3", this.asParams(input, "q"), opt); }
}
...
class ScravBotApiManager {
  ...
  makeProviderClasses() {
    return {
      ...
      tegarx: TegarxApiProvider,
      harz: HarzApiProvider
    };
  }
  ...
  makeProviders() {
    return {
      ...
      tegarx: {
        baseURL: "https://api.tegarx.web.id",
        auth: {
          params: {
            apikey: () => this.pickCfg(["APIkey.tegarx"]),
          },
        },
      },
      harz: {
        baseURL: "https://api.harzrestapi.web.id",
        auth: {
          params: {
            apikey: () => this.pickCfg(["APIkey.harz"], "FREE"),
          },
        },
      },
    };
...
module.exports = { ScravBotApiManager, ScravBotApiProvider, ScravBotApi };
